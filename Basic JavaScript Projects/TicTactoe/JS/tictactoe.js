...
function placeXOrO(squareNumber) {
    ...
    // Return false if the square was already selected.
    return false;
}
...
function computersTurn() {
    ...
    while (!success) {
        ...
        // If the square is available, place the computer's move.
...
// This function resets the game in a tie or a win situation.
function resetGame() {
